...
impl CommentStyle {
    ...
    fn for_extension(ext: &str) -> Self {
        match ext {
            // C-style languages
            "c" | "h" | "cpp" | "hpp" | "cc" | "hh" | "cxx" | "hxx" => Self::Block {
                start: "/*",
                end: "*/",
                line_prefix: " *",
            },
            "cs" | "java" | "js" | "jsx" | "ts" | "tsx" | "rs" | "scala" | "kt" | "kts"
            | "swift" | "go" | "m" | "mm" | "d" | "zig" | "dart" => Self::Block {
                start: "/*",
                end: "*/",
                line_prefix: " *",
            },
            ...
            // Shell scripts
            "sh" | "bash" | "zsh" => Self::LineWithShebang {
                prefix: "#",
                shebang: "#!/usr/bin/env bash",
            },
            "fish" => Self::LineWithShebang {
                prefix: "#",
                shebang: "#!/usr/bin/env fish",
            },

            // Other scripting languages with shebang
            "rb" => Self::LineWithShebang {
                prefix: "#",
                shebang: "#!/usr/bin/env ruby",
            },
            "pl" | "pm" => Self::LineWithShebang {
                prefix: "#",
                shebang: "#!/usr/bin/env perl",
            },
            "r" | "R" => Self::LineWithShebang {
                prefix: "#",
                shebang: "#!/usr/bin/env Rscript",
            },
            "jl" => Self::LineWithShebang {
                prefix: "#",
